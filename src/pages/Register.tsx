  ...
  return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-4">
      <div className="w-full max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Main Form */}
          <Card className="p-10 shadow-xl animate-fade-in" style={{
          animationDelay: '100ms'
        }}>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <Input type="text" placeholder="Choose your builder name" value={username} onChange={e => setUsername(e.target.value)} required className="h-12" />
              </div>
              
              <div>
                <Input type="email" placeholder="your@email.com (we'll never spam!)" value={email} onChange={e => setEmail(e.target.value)} required className="h-12" />
              </div>
              
              <div>
                <Input type="password" placeholder="Create a strong password" value={password} onChange={e => setPassword(e.target.value)} required minLength={6} className="h-12" />
              </div>
              
              <Button type="submit" className="w-full h-12 text-base font-semibold transition-transform hover:scale-105" disabled={loading}>
            ...
            <Button type="button" variant="outline" className="w-full h-12" onClick={handleGoogleSignIn}>
          ...
          <div className="space-y-6">
            ...
            {/* Social Proof */}
            <Card className="p-6 shadow-lg bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20 animate-fade-in" style={{
            animationDelay: '400ms'
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm italic mb-2">"Love the gamified experience! Makes vibe 
coding so much more engaging."</p>
